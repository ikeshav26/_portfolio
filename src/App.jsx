...
import avatar from '../public/203427446.jpeg'
...
const App = () => {
  ...
  return (
    <div 
      ...
      className="min-h-screen lg:h-screen w-full bg-[#030303] text-[#a1a1aa] font-sans selection:bg-white/10 overflow-y-auto lg:overflow-hidden flex items-center justify-center p-6 lg:p-12 relative"
    >
      ...
      <div className="relative z-10 w-full max-w-5xl grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-24 animate-in fade-in slide-in-from-bottom-4 duration-1000 items-center py-10 lg:py-0">
        ...
        <main className="md:col-span-7 space-y-4">
          {SOCIAL_LINKS.map((link, idx) => (
            <a 
              ...
              className="flex items-center justify-between p-5 bg-white/[0.02] border border-white/5 rounded-[1.5rem] backdrop-blur-2xl transition-all duration-500 group hover:bg-white/[0.04] hover:border-white/10 hover:md:translate-x-2 shadow-xl"
            >
              ...
              <div className="w-10 h-10 rounded-full border border-white/0 flex items-center justify-center group-hover:border-white/5 group-hover:bg-white/5 transition-all shrink-0">
