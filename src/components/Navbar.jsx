...
const Navbar = () => {
  ...
  return (
    <header className="w-full px-4 py-4 max-w-7xl mx-auto">
      ...
      <div
        className={clsx(
          "transition-all duration-500 ease-in-out rounded-3xl overflow-hidden",
          mobileMenuOpen ? "max-h-[500px]" : "max-h-[80px]"
        )}
      >
        <nav className="flex flex-col md:flex-row items-center justify-between border border-slate-700 px-6 py-4 text-sm text-white dark:text-white bg-white dark:bg-black min-h-[48px]">
          ...
          <div className="w-full flex items-center justify-between h-12">
            ...
            <div className="flex items-center gap-3 md:hidden">
              ...
              <button
                ...
                className="text-gray-700 dark:text-gray-300 transition-transform duration-300 hover:scale-110 flex items-center"
              >
                <svg
                  className={clsx(
