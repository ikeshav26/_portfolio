  ...
  return (
    <div className='min-h-screen w-full flex flex-col items-center justify-center gap-10 transition-colors duration-300 '>
      <div className='flex flex-col items-center justify-center gap-4'>
        ...
        <div className='flex text-sm md:text-xl lg:text-3xl items-center justify-center gap-3 textHome'>
      ...
      <div className='absolute top-5 left-5 flex gap-2 text-3xl dark:text-white'>
        <Link to="https://www.instagram.com/keshav_gilhotra_/?hl=en" target="_blank" rel="noopener noreferrer" className=' dark:bg-neutral-800 p-2 rounded-xl hover:scale-105 hover:bg-neutral-700 transition-all'>
          <AiFillInstagram />
        </Link>
        <Link to="https://github.com/ikeshav26" target="_blank" rel="noopener noreferrer" className=' dark:bg-neutral-800 p-2 rounded-xl  hover:scale-105 transition-all  hover:bg-neutral-700'>
          <AiFillGithub />
        </Link>
        <Link to="https://x.com/KeshavGilh5995" target="_blank" rel="noopener noreferrer" className=' dark:bg-neutral-800 p-2 rounded-xl hover:scale-105 transition-all  hover:bg-neutral-700'>
          <AiFillTwitterCircle />
        </Link>
      </div>
